...
#define SE_uom_exists (1 << 16)
    ...
    @var SE_ReadingType_t::tieredConsumptionBlocks
...
#define SE_vRef_exists (1 << 14)
    ...
    @var SE_DERCurve_t::autonomousVRefEnable
...
#define SE_excitation0_true (1 << 0)
    ...
    @var SE_PowerFactorWithExcitation_t::excitation
    True when DER is absorbing reactive power (under-excited), false
...
#define SE_rampTms_exists (1 << 27)
    ...
    @var SE_DERControlBase_t::opModConnect
    ...
    @var SE_DERControlBase_t::opModEnergize
...
#define SE_reason_exists (1 << 2)
    ...
    @var SE_EventStatus_t::potentiallySuperseded
...
#define SE_TargetReduction_exists (1 << 9)
    ...
    @var SE_EndDeviceControl_t::drProgramMandatory
    ...
    @var SE_EndDeviceControl_t::loadShiftForward
...
#define SE_RPLSourceRoutesListLink_exists (1 << 2)
    ...
    @var SE_RPLInstance_t::DODAGroot
    See [RFC 6550].

    @var SE_RPLInstance_t::flags
    See [RFC 6550].

    @var SE_RPLInstance_t::groundedFlag
    See [RFC 6550].
...
#define SE_LLInterfaceListLink_exists (1 << 26)
    ...
    @var SE_IPInterface_t::ifPromiscuousMode
    Use rules from [RFC 2863].
